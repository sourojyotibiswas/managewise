...
import TodoCard from "../TodoCard/page";
...
const idToColumnText: {
  ...
  todo: "Pending Pursuits",
  inprogress: "On the Grind",
  done: "Completed Chronicles",
};

const Column = ({ id, todos, index }: Props) => {
  const [searchString, setNewTaskType] = useTaskStore((state) => [
    state.searchString,
